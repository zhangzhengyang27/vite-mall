    ...
    <div>
        ...
        <el-card shadow="never" class="border-0">
            ...
            <ListHeader layout="create,refresh" @create="handleCreate" @refresh="getData">
                ...
                <el-button size="small" @click="handleMultiStatusChange(1)" v-if="searchForm.tab == 'all' || searchForm.tab == 'off'">
                    上架
                </el-button>
                <el-button size="small" @click="handleMultiStatusChange(0)" v-if="searchForm.tab == 'all' || searchForm.tab == 'saling'">
                    下架
                </el-button>
            </ListHeader>
...
import { createGoods, deleteGoods, destroyGoods, getGoodsList, restoreGoods, updateGoods, updateGoodsStatus } from '@/api/goods'
